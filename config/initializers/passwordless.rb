Passwordless.default_from_address = 'Fighting_Aggies_Application@example.com'
...
Passwordless.restrict_token_reuse = true # By default a magic link token can be used multiple times.
...
Passwordless.success_redirect_path = '/authorize' # When a user succeeds in logging in.
